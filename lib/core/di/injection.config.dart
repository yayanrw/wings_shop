...
import '../../data/datasources/remote/source/product_data_source.dart' as _i11;
...
import '../../data/repositories/product_repository_impl.dart' as _i13;
import '../../data/repositories/transaction_repository_impl.dart' as _i16;
import '../../data/repositories/user_credentials_repository_impl.dart' as _i9;
...
import '../../domain/repositories/user_credentials_repository.dart' as _i8;
import '../../domain/usescases/auth/login.dart' as _i25;
import '../../domain/usescases/auth/logout.dart' as _i26;
import '../../domain/usescases/user_credentials/get_token.dart' as _i10;
...
import '../../presentation/pages/profile/profile_notifier.dart' as _i6;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i6.ProfileNotifier>(() => _i6.ProfileNotifier());
    gh.lazySingleton<_i7.UserCredentialsDataSource>(
        () => _i7.UserCredentialsDataSourceImpl());
    gh.lazySingleton<_i8.UserCredentialsRepository>(() =>
        _i9.UserCredentialsRepositoryImpl(gh<_i7.UserCredentialsDataSource>()));
    gh.lazySingleton<_i10.GetToken>(
        () => _i10.GetToken(gh<_i8.UserCredentialsRepository>()));
    gh.lazySingleton<_i11.ProductDataSource>(() => _i11.ProductDataSourceImpl(
          gh<_i5.Client>(),
          gh<_i10.GetToken>(),
        ));
    gh.lazySingleton<_i12.ProductRepository>(
        () => _i13.ProductRepositoryImpl(gh<_i11.ProductDataSource>()));
    ...
    gh.lazySingleton<_i25.LogIn>(() => _i25.LogIn(
          ...
          gh<_i8.UserCredentialsRepository>(),
        ));
